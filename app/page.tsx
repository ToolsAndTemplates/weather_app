...
export default function Home() {
  ...
  return (
    <main className="weather-background py-6 sm:py-12 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
      ...
      <div className="content-wrapper container mx-auto max-w-7xl flex flex-col items-center">
        {/* Header */}
        <div className="text-center mb-6 sm:mb-8 animate-fade-in">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-2 sm:mb-3 drop-shadow-2xl [text-shadow:_2px_2px_8px_rgb(0_0_0_/_40%)]">
            Weather App
          </h1>
          <p className="text-base sm:text-xl md:text-2xl text-white/90 drop-shadow-lg px-4 [text-shadow:_1px_1px_4px_rgb(0_0_0_/_30%)]">
        ...
        {/* Error Message */}
        {error && (
          <div className="bg-red-500/80 backdrop-blur-sm border border-red-400/30 text-white px-4 sm:px-6 py-4 rounded-xl mb-6 max-w-md w-full animate-fade-in shadow-lg">
        ...
        {isLoading && (
          <div className="glass rounded-2xl shadow-2xl p-8 sm:p-12 w-full max-w-md animate-fade-in">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-white text-base sm:text-lg font-semibold">{loadingMessage}</p>
        ...
        {!isLoading && !weatherData && !error && (
          <div className="glass rounded-2xl shadow-2xl p-8 sm:p-12 lg:p-16 max-w-md w-full text-center animate-pulse-slow">
            <div className="text-7xl sm:text-8xl mb-4 sm:mb-6 animate-bounce">🌤</div>
